...
import { tabs, places } from '../utilities/database.js';
            ...
            <div className='flexColumn'>
                ...
                <div className='section'>
                    ...
                    <div className={styles.tabHeader}>
                        {tabs.map((text, i) => (
                            <div key={text} className={`${i === currentTab ? styles.tabActive : styles.tabInactive}`} onClick={() => setCurrentTab(i)}>
